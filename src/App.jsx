...
export default function App() {
  ...
  async function cargarDatos() {
    try {
      const [v, e, conteo] = await Promise.all([ 
        ...
        supabase.rpc('obtener_conteo_total_votantes') // Permite saltar el RLS para que los coordinadores vean el número real general
      ]);
      setVotantes(v.data || []); 
      setEquipo(e.data || []);
  ...
  return (
    <div style={{ background: "white", minHeight: "100vh", fontFamily: "'Inter', sans-serif", width: "100%", overflowX: "hidden" }}>
      ...
      <section style={{ position: "relative", width: "100%", background: "linear-gradient(180deg, #ffffff 0%, #f8fafc 100%)", padding: isMobile ? "40px 10px 160px 10px" : "50px 20px 180px 20px", textAlign: "center", boxSizing: "border-box" }}>
        
        <BridgeCityBackground />

        <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", alignItems: "center", maxWidth: isMobile ? "100%" : "800px", margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "'Inter', sans-serif", fontStyle: "italic", fontWeight: "900", color: "#C8102E", fontSize: isMobile ? "28px" : "65px", margin: "0 0 5px 0", textTransform: "uppercase", letterSpacing: "-1px", lineHeight: 1.1 }}>
            HAGAMOS QUE SUCEDA
          </h1>
          ...
          <button style={{ background: "linear-gradient(90deg, #a00d25 0%, #C8102E 50%, #a00d25 100%)", borderRadius: "50px", padding: "8px 30px 8px 8px", display: "flex", alignItems: "center", gap: "15px", boxShadow: "0 10px 25px rgba(200,16,46,0.4)", width: isMobile ? "100%" : "auto", maxWidth: "550px", border: "none" }}>
            ...
            <span style={{ color: "white", fontWeight: "800", fontSize: isMobile ? "12px" : "19px", flex: 1, textAlign: "center" }}>
      ...
      <div style={{ position: "relative", zIndex: 20, marginTop: "-80px", display: "flex", justifyContent: "center", padding: isMobile ? "0 10px" : "0 20px", marginBottom: "50px", width: "100%", boxSizing: "border-box" }}>
        <div style={{ background: "white", borderRadius: "20px", padding: isMobile ? "30px 10px" : "25px 50px", display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: "center", justifyContent: "center", gap: isMobile ? "15px" : "20px", boxShadow: "0 15px 35px rgba(0,0,0,0.1)", position: "relative", border: "1px solid #f1f5f9", maxWidth: "850px", width: "100%", boxSizing: "border-box" }}>
          
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginRight: isMobile ? 0 : "10px" }}>
            <div style={{ background: "#C8102E", color: "white", width: "50px", height: "50px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 5px 15px rgba(200,16,46,0.3)" }}>
              <Users size={28} strokeWidth={2.5} />
            </div>
            <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: "900", fontSize: isMobile ? "24px" : "32px", color: "#1e293b", fontStyle: "italic" }}>YA SOMOS</span>
          </div>

          <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <BrilloNumero />
            <AccentLeft />
            <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: "900", fontSize: isMobile ? "65px" : "110px", color: "#C8102E", fontStyle: "italic", lineHeight: 0.8, letterSpacing: "-2px", textShadow: "2px 2px 0px rgba(0,0,0,0.05)" }}>
              {totalVotantesGeneral.toLocaleString('es-PY')}
            </span>
            <AccentRight />
          </div>

          <div style={{ fontFamily: "'Inter', sans-serif", fontWeight: "800", color: "#64748b", fontSize: isMobile ? "16px" : "18px", lineHeight: 1.2, textAlign: isMobile ? "center" : "left", marginLeft: isMobile ? 0 : "10px" }}>
      ...
      <nav style={{ display: "flex", background: "#f1f5f9", padding: "10px 5px 0 5px", position: "sticky", top: 0, zIndex: 90, borderBottom: "1px solid #e2e8f0", width: "100%", boxSizing: "border-box" }}>
      ...
      <main style={{ maxWidth: "1100px", margin: "0 auto", padding: isMobile ? "20px 10px" : "30px 15px", paddingBottom: 120, boxSizing: "border-box", width: "100%" }}>
        {activeTab === "inicio" && (
        ...
        {activeTab === "reportes" && userRole === "administrador" && (
          <div style={{ display: "grid", gap: 30 }}>
            ...
            <div style={{ background: "white", padding: isMobile ? 20 : 25, borderRadius: "25px", boxShadow: "0 10px 30px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9" }}>
