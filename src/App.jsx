...
function GreenHeart() {
  return (
    <img
      src={logocarmona}
      alt="Logo Carmona"
      style={{ width: "70px", height: "40px", borderRadius: "100px" }}
    />
  );
}
...
export default function App() {
  ...
  const exportarExcel = async () => {
    ...
    const crearHoja = (nombreHoja, lista) => {
      ...
      headerRow.values = ["Nro", "Nombre", "Apellido", "Cedula", "Orden", "Mesa", "Seccional", "Local", "Captado por"];
  ...
  return (
    <div style={{ background: "#f8fafc", minHeight: "100vh", fontFamily: "Inter, sans-serif" }}>
      <header style={{ background: "white", padding: isMobile ? "25px 15px" : "40px", textAlign: "center", boxShadow: "0 4px 15px rgba(0,0,0,0.05)", position: "relative" }}>
        <button onClick={() => supabase.auth.signOut()} style={{ background: "#f1f5f9", color: "#64748b", padding: "8px 15px", borderRadius: "10px", border: "none", fontWeight: "800", cursor: "pointer", position: "absolute", right: 20, top: 20, fontSize: "11px" }}>
          SALIR
        </button>

        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
          <ANRLogo />
          <h1 style={{ fontFamily: "Montserrat", fontWeight: "900", color: "#C8102E", fontSize: isMobile ? "24px" : "44px", margin: 0, textTransform: "uppercase", letterSpacing: "-1.5px" }}>
            HAGAMOS QUE SUCEDA
          </h1>
          <div style={{ background: "#f1f5f9", padding: "6px 20px", borderRadius: "50px", display: "flex", alignItems: "center", gap: 8 }}>
            <GreenHeart />
            <h2 style={{ fontFamily: "Montserrat", fontWeight: "800", color: "#475569", fontSize: isMobile ? "12px" : "16px", margin: 0 }}>
