...
export default function App() {
  ...
  const exportarExcel = async () => {
    ...
    const crearHoja = (nombreHoja, lista) => {
      ...
      sheet.addRow(["HAGAMOS QUE SUCEDA"]); sheet.mergeCells("A1:K1");
      ...
      sheet.addRow(["Darío Carmona Concejal 2026"]); sheet.mergeCells("A2:K2");
      ...
      sheet.addRow([]);
      sheet.columns = [
        { header: "Nro", key: "nro", width: 5 }, { header: "Nombre", key: "nom", width: 20 }, { header: "Apellido", key: "ape", width: 20 },
          ...
          <div style={{ display: "grid", gap: 25 }}>
            ...
            <div className="card" style={{ background: "white", padding: isMobile ? 25 : 40, borderRadius: "25px", boxShadow: "0 10px 30px rgba(0,0,0,0.03)" }}>
              ...
              <form onSubmit={guardarVotante} style={{ display: "grid", gap: 15 }}>
                ...
                {/* NUEVOS CAMPOS: TELÉFONO Y FECHA DE NACIMIENTO */}
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 15 }}>
                  <div><label style={{ fontWeight: "800", fontSize: "11px", color: "#C8102E" }}>TELÉFONO</label><input type="tel" placeholder="09xx..." value={formVotante.telefono} onChange={(e) => setFormVotante({ ...formVotante, telefono: e.target.value })} style={{ width: "100%", padding: "14px", borderRadius: "12px", border: "1px solid #e2e8f0", fontSize: "16px" }} /></div>
