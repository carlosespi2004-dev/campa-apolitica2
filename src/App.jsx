...
export default function App() {
  ...
  const tabStyle = (id) => ({
    flex: "1 1 auto", padding: "18px 5px", border: "none", background: activeTab === id ? "#C8102E" : "#f1f5f9", color: activeTab === id ? "white" : "#64748b", fontWeight: "900", fontSize: isMobile ? "10px" : "13px", textTransform: "uppercase", cursor: "pointer", borderRadius: "15px 15px 0 0", transition: "0.3s", margin: isMobile ? "2px" : "0 2px", outline: "none", minWidth: isMobile ? "80px" : "auto"
  });

  return (
    // CORRECCIÓN RESPONSIVE: Añadido overflowX: "hidden", maxWidth: "100vw", boxSizing: "border-box" al contenedor principal
    <div style={{ background: "white", minHeight: "100vh", fontFamily: "'Inter', sans-serif", width: "100%", maxWidth: "100vw", overflowX: "hidden", boxSizing: "border-box" }}>
      ...
      <header style={{ background: "white", padding: isMobile ? "12px 10px" : "15px 30px", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid #e2e8f0", position: "relative", zIndex: 100, width: "100%", boxSizing: "border-box" }}>
        ...
        {/* CORRECCIÓN RESPONSIVE: Ajuste de GAP en móvil para el avatar y logout */}
      ...
      <section style={{ position: "relative", width: "100%", background: "linear-gradient(180deg, #ffffff 0%, #f8fafc 100%)", padding: isMobile ? "30px 10px 120px 10px" : "50px 20px 180px 20px", textAlign: "center", boxSizing: "border-box" }}>
      ...
      {/* CORRECCIÓN RESPONSIVE: Anchos al 100% y box-sizing para evitar que empuje horizontalmente */}
      <div style={{ position: "relative", zIndex: 20, marginTop: isMobile ? "-50px" : "-80px", display: "flex", justifyContent: "center", padding: "0 15px", marginBottom: "40px", width: "100%", boxSizing: "border-box" }}>
        <div style={{ background: "white", borderRadius: "20px", padding: isMobile ? "25px 15px" : "25px 50px", display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: "center", justifyContent: "center", gap: isMobile ? "15px" : "20px", boxShadow: "0 15px 35px rgba(0,0,0,0.1)", position: "relative", border: "1px solid #f1f5f9", maxWidth: "850px", width: "100%", boxSizing: "border-box" }}>
          ...
          <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center", maxWidth: "100%" }}>
            <BrilloNumero />
            <AccentLeft />
            {/* CORRECCIÓN RESPONSIVE: clamp() para que el número achique automáticamente si la pantalla es estrecha */}
      ...
      {/* CORRECCIÓN RESPONSIVE: flexWrap="wrap" añadido para que las pestañas bajen si no caben horizontalmente */}
      <nav style={{ display: "flex", flexWrap: isMobile ? "wrap" : "nowrap", gap: isMobile ? "5px" : "0", background: "#f1f5f9", padding: "10px", position: "sticky", top: 0, zIndex: 90, borderBottom: "1px solid #e2e8f0", width: "100%", boxSizing: "border-box" }}>
      ...
      {/* CORRECCIÓN RESPONSIVE: width: 100% y box-sizing al main contenedor de toda la info de abajo */}
      <main style={{ maxWidth: "1100px", margin: "0 auto", padding: isMobile ? "20px 15px" : "30px 15px", paddingBottom: 120, width: "100%", boxSizing: "border-box" }}>
        {activeTab === "inicio" && (
          <div style={{ display: "grid", gap: 25, width: "100%" }}>
            <div style={{ background: "white", padding: isMobile ? 20 : 35, borderRadius: "25px", boxShadow: "0 10px 30px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9", width: "100%", boxSizing: "border-box" }}>
              ...
              <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: 10 }}>
                <input type="text" value={cedulaRapida} onChange={(e) => setCedulaRapida(e.target.value.replace(/\D/g, ''))} placeholder="Ingrese número de cédula..." style={{ flex: 1, padding: "15px", borderRadius: "12px", border: "2px solid #f1f5f9", fontSize: "16px", outline: "none", boxSizing: "border-box" }} />
            ...
            <div id="formVotante" style={{ background: "white", padding: isMobile ? 25 : 40, borderRadius: "25px", boxShadow: "0 10px 30px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9", width: "100%", boxSizing: "border-box" }}>
        ...
        {/* CORRECCIÓN RESPONSIVE: Tablas envueltas en display: block y width 100% para no forzar contenedor padre */}
        {activeTab === "votantes" && (
          ...
          <div style={{ background: "white", padding: isMobile ? 15 : 30, borderRadius: "25px", boxShadow: "0 10px 30px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9", width: "100%", boxSizing: "border-box" }}>
            ...
            <div style={{ background: "#f8fafc", padding: "25px", borderRadius: "20px", border: "1px solid #e2e8f0", textAlign: "center", maxWidth: "500px", margin: "0 auto", width: "100%", boxSizing: "border-box" }}>
              ...
              <p style={{ margin: "10px 0 0 0", color: "#1e293b", fontWeight: "700", fontSize: "17px" }}>
                Han votado <span style={{color: "#C8102E", fontWeight: "900"}}>{listaGeneralAdmin.filter(v => v.ha_votado).length.toLocaleString('es-PY')}</span> de <span style={{fontWeight: "900"}}>{listaGeneralAdmin.length.toLocaleString('es-PY')}</span> registradas.
              </p>
            </div>
          </div>
        )}
          ...
          <div style={{ display: "grid", gap: 30, width: "100%" }}>
            <div style={{ background: "white", padding: isMobile ? 20 : 35, borderRadius: "25px", boxShadow: "0 10px 30px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9", width: "100%", boxSizing: "border-box" }}>
              ...
              <form onSubmit={guardarEquipo} style={{ display: "grid", gap: 18 }}>
                <input type="text" placeholder="Nombre completo" value={formEquipo.nombre} onChange={(e) => setFormEquipo({ ...formEquipo, nombre: e.target.value })} required style={{ padding: 14, borderRadius: 12, border: "1px solid #e2e8f0", fontSize: "16px", outline: "none", width: "100%", boxSizing: "border-box" }} />
                <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 18 }}>
                  <input type="text" placeholder="Teléfono" value={formEquipo.telefono} onChange={(e) => setFormEquipo({ ...formEquipo, telefono: e.target.value.replace(/\D/g, '') })} style={{ padding: 14, borderRadius: 12, border: "1px solid #e2e8f0", fontSize: "16px", outline: "none", width: "100%", boxSizing: "border-box" }} />
                  <input type="text" placeholder="Zona o Barrio" value={formEquipo.zona} onChange={(e) => setFormEquipo({ ...formEquipo, zona: e.target.value })} style={{ padding: 14, borderRadius: 12, border: "1px solid #e2e8f0", fontSize: "16px", outline: "none", width: "100%", boxSizing: "border-box" }} />
                </div>
                {!editIdEquipo && (
                  <div style={{ padding: "18px", background: "#f8fafc", borderRadius: "15px", border: "1px dashed #cbd5e1" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 15 }}>
                      <input type="email" placeholder="Correo electrónico" value={formEquipo.email} onChange={(e) => setFormEquipo({ ...formEquipo, email: e.target.value })} required style={{ padding: 14, borderRadius: 12, border: "1px solid #e2e8f0", fontSize: "15px", outline: "none", width: "100%", boxSizing: "border-box" }} />
                      <input type="password" placeholder="Contraseña (mín 6 letras)" value={formEquipo.password} onChange={(e) => setFormEquipo({ ...formEquipo, password: e.target.value })} required minLength={6} style={{ padding: 14, borderRadius: 12, border: "1px solid #e2e8f0", fontSize: "15px", outline: "none", width: "100%", boxSizing: "border-box" }} />
                    </div>
                  </div>
                )}
                <select value={formEquipo.rol} onChange={(e) => setFormEquipo({ ...formEquipo, rol: e.target.value })} required style={{ padding: 14, borderRadius: 12, border: "1px solid #e2e8f0", fontSize: "16px", background: "white", outline: "none", width: "100%", boxSizing: "border-box" }}>
                ...
                <div key={m?.id} style={{ marginBottom: 18, padding: "15px", background: index < 3 ? "#fef2f2" : "white", borderRadius: "12px", border: index < 3 ? "1px solid #fecaca" : "1px solid #e2e8f0" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                    <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                        ...
                        <span style={{ fontWeight: "700", color: "#1e293b", fontSize: "15px", wordBreak: "break-word" }}>{m?.nombre}</span>
                    </div>
                    <span style={{ fontSize: "15px", fontWeight: "800", color: "#C8102E", whiteSpace: "nowrap" }}>{m?.cantidad.toLocaleString('es-PY')} <small style={{color: "#64748b", fontWeight: "600"}}>votos</small></span>
                  </div>
